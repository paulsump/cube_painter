...
class OldHexagonButton extends StatefulWidget {
  final bool enabled;
  final IconData? icon;
  ...
  @override
  State<OldHexagonButton> createState() => _HexagonState();
}

class _HexagonState extends State<OldHexagonButton>
